...
{
	private static final int ANTS_POPULATION = 3;
	private static final double GREEDYNESS = 0.90; // 95% greedy 5% explorer
	private int[] antPosition;
	private boolean[][] visitedNode;
	private double[][] pheromone;
	private double defaultPheromone;
	private static final double ALPHA = 0.1;
	private static final double RHO = 0.91; // Pheromone persistance
